  ...
  return (
    <section className="relative min-h-screen h-screen overflow-hidden ">
      ...
      <div className="relative h-full w-full">
        ...
        {/* Hero Content Box */}
        <div className="absolute left-8 md:left-32 w-96 h-56 top-1/4 bg-teal-700 text-white p-6 rounded-2xl shadow-lg max-w-screen-md bg-opacity-80">
        <h1 className="text-xl md:text-3xl font-bold leading-tight text-center p-5">AboutUS</h1>
        
          
        <p className="text-sm md:text-3xl font-bold leading-tight text-center cursor-pointer hover:text-gray-300 transition"
            onClick={() => navigate("/")} >
            Home/About</p>
        </div>
